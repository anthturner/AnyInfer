...
CANDIDATES: tuple[Mapping[str, Any], ...] = (
    # --- general chat -------------------------------------------------------------------
    {
        "id": "llama-3.2-1b-instruct", "family": "llama-3.2",
        "display_name": "Llama 3.2 1B Instruct", "parameter_size": "1B",
        "context_window": 131072, "license": "llama-3.2-community",
    ...
    {
        "id": "llama-3.2-3b-instruct", "family": "llama-3.2",
        "display_name": "Llama 3.2 3B Instruct", "parameter_size": "3B",
        "context_window": 131072, "license": "llama-3.2-community",
    ...
    {
        "id": "llama-3.1-8b-instruct", "family": "llama-3.1",
        "display_name": "Llama 3.1 8B Instruct", "parameter_size": "8B",
        "context_window": 131072, "license": "llama-3.1-community",
    ...
    {
        "id": "qwen2.5-1.5b-instruct", "family": "qwen2.5",
        "display_name": "Qwen2.5 1.5B Instruct", "parameter_size": "1.5B",
    ...
    {
        "id": "qwen2.5-7b-instruct", "family": "qwen2.5",
        "display_name": "Qwen2.5 7B Instruct", "parameter_size": "7B",
        "context_window": 32768, "license": "apache-2.0",
    ...
    {
        "id": "qwen2.5-14b-instruct", "family": "qwen2.5",
        "display_name": "Qwen2.5 14B Instruct", "parameter_size": "14B",
        "context_window": 32768, "license": "apache-2.0",
    ...
    {
        "id": "qwen2.5-32b-instruct", "family": "qwen2.5",
        "display_name": "Qwen2.5 32B Instruct", "parameter_size": "32B",
        "context_window": 32768, "license": "apache-2.0",
        "best_at": ["general-chat", "tool-use"],
    ...
    {
        "id": "qwen3-4b", "family": "qwen3",
        "display_name": "Qwen3 4B", "parameter_size": "4B",
        "context_window": 32768, "license": "apache-2.0",
    ...
    {
        "id": "qwen3-8b", "family": "qwen3",
        "display_name": "Qwen3 8B", "parameter_size": "8B",
        "context_window": 32768, "license": "apache-2.0",
    ...
    {
        "id": "qwen3-14b", "family": "qwen3",
        "display_name": "Qwen3 14B", "parameter_size": "14B",
        "context_window": 32768, "license": "apache-2.0",
    ...
    {
        "id": "qwen3-32b", "family": "qwen3",
        "display_name": "Qwen3 32B", "parameter_size": "32B",
        "context_window": 32768, "license": "apache-2.0",
    ...
    {
        "id": "qwen3-30b-a3b", "family": "qwen3",
        "display_name": "Qwen3 30B-A3B (MoE)", "parameter_size": "30B",
        "context_window": 32768, "license": "apache-2.0",
        "best_at": ["general-chat", "reasoning"],
    ...
    {
        "id": "gemma-3-1b-it", "family": "gemma-3",
        "display_name": "Gemma 3 1B Instruct", "parameter_size": "1B",
        "context_window": 32768, "license": "gemma-terms",
    ...
    {
        "id": "gemma-3-4b-it", "family": "gemma-3",
        "display_name": "Gemma 3 4B Instruct", "parameter_size": "4B",
        "context_window": 131072, "license": "gemma-terms",
        "best_at": ["general-chat", "multilingual"],
    ...
    {
        "id": "gemma-3-12b-it", "family": "gemma-3",
        "display_name": "Gemma 3 12B Instruct", "parameter_size": "12B",
        "context_window": 131072, "license": "gemma-terms",
    ...
    {
        "id": "gemma-3-27b-it", "family": "gemma-3",
        "display_name": "Gemma 3 27B Instruct", "parameter_size": "27B",
        "context_window": 131072, "license": "gemma-terms",
        "best_at": ["general-chat", "multilingual"],
    ...
    {
        "id": "phi-4", "family": "phi-4",
        "display_name": "Phi-4", "parameter_size": "14B",
        "context_window": 16384, "license": "mit",
    ...
    {
        "id": "phi-4-mini-instruct", "family": "phi-4",
        "display_name": "Phi-4 Mini Instruct", "parameter_size": "3.8B",
        "context_window": 131072, "license": "mit",
    ...
    {
        "id": "mistral-7b-instruct-v0.3", "family": "mistral",
        "display_name": "Mistral 7B Instruct v0.3", "parameter_size": "7B",
        "context_window": 32768, "license": "apache-2.0",
    ...
    {
        "id": "mistral-nemo-instruct", "family": "mistral",
        "display_name": "Mistral Nemo Instruct", "parameter_size": "12B",
        "context_window": 131072, "license": "apache-2.0",
    ...
    {
        "id": "mistral-small-3.2", "family": "mistral",
        "display_name": "Mistral Small 3.2 Instruct", "parameter_size": "24B",
        "context_window": 131072, "license": "apache-2.0",
        "best_at": ["general-chat", "tool-use"],
    ...
    {
        "id": "gpt-oss-20b", "family": "gpt-oss",
        "display_name": "gpt-oss 20B (MoE)", "parameter_size": "20B",
        "context_window": 131072, "license": "apache-2.0",
    ...
    {
        "id": "gpt-oss-120b", "family": "gpt-oss",
        "display_name": "gpt-oss 120B (MoE)", "parameter_size": "120B",
        "context_window": 131072, "license": "apache-2.0",
    ...
    {
        "id": "granite-3.3-8b-instruct", "family": "granite",
        "display_name": "Granite 3.3 8B Instruct", "parameter_size": "8B",
        "context_window": 131072, "license": "apache-2.0",
    ...
    {
        "id": "smollm2-1.7b-instruct", "family": "smollm2",
        "display_name": "SmolLM2 1.7B Instruct", "parameter_size": "1.7B",
        "context_window": 8192, "license": "apache-2.0",
        "best_at": ["low-resource", "drafting"],
    ...
    {
        "id": "olmo-2-7b-instruct", "family": "olmo-2",
        "display_name": "OLMo 2 7B Instruct", "parameter_size": "7B",
        "context_window": 4096, "license": "apache-2.0",
        "best_at": ["general-chat"],
    ...
    {
        "id": "falcon3-7b-instruct", "family": "falcon3",
        "display_name": "Falcon 3 7B Instruct", "parameter_size": "7B",
        "context_window": 32768, "license": "falcon-llm-2.0",
    ...
    {
        "id": "hermes-3-llama-3.1-8b", "family": "hermes-3",
        "display_name": "Hermes 3 (Llama 3.1 8B)", "parameter_size": "8B",
        "context_window": 131072, "license": "llama-3.1-community",
    ...
    {
        "id": "glm-4-9b-chat", "family": "glm-4",
        "display_name": "GLM-4 9B Chat", "parameter_size": "9B",
        "context_window": 131072, "license": "mit",
        "best_at": ["general-chat", "multilingual"],
    ...
    # --- reasoning ----------------------------------------------------------------------
    {
        "id": "deepseek-r1-distill-qwen-1.5b", "family": "deepseek-r1",
        "display_name": "DeepSeek-R1 Distill Qwen 1.5B", "parameter_size": "1.5B",
        "context_window": 131072, "license": "mit",
    ...
    {
        "id": "deepseek-r1-distill-qwen-7b", "family": "deepseek-r1",
        "display_name": "DeepSeek-R1 Distill Qwen 7B", "parameter_size": "7B",
        "context_window": 131072, "license": "mit",
        "best_at": ["reasoning", "math"],
    ...
    {
        "id": "deepseek-r1-distill-qwen-14b", "family": "deepseek-r1",
        "display_name": "DeepSeek-R1 Distill Qwen 14B", "parameter_size": "14B",
        "context_window": 131072, "license": "mit",
        "best_at": ["reasoning", "math"],
    ...
    {
        "id": "deepseek-r1-distill-qwen-32b", "family": "deepseek-r1",
        "display_name": "DeepSeek-R1 Distill Qwen 32B", "parameter_size": "32B",
        "context_window": 131072, "license": "mit",
        "best_at": ["reasoning", "math"],
    ...
    {
        "id": "deepseek-r1-distill-llama-70b", "family": "deepseek-r1",
        "display_name": "DeepSeek-R1 Distill Llama 70B", "parameter_size": "70B",
        "context_window": 131072, "license": "mit",
        "best_at": ["reasoning"],
    ...
    {
        "id": "qwq-32b", "family": "qwq",
        "display_name": "QwQ 32B", "parameter_size": "32B",
        "context_window": 32768, "license": "apache-2.0",
        "best_at": ["reasoning", "math"],
    ...
    # --- coding -------------------------------------------------------------------------
    {
        "id": "qwen2.5-coder-1.5b-instruct", "family": "qwen2.5-coder",
        "display_name": "Qwen2.5-Coder 1.5B Instruct", "parameter_size": "1.5B",
        "context_window": 32768, "license": "apache-2.0",
    ...
    },
    {
        ...
        "display_name": "Qwen2.5-Coder 7B Instruct", "parameter_size": "7B",
        "context_window": 32768, "license": "apache-2.0",
    ...
    },
    {
        ...
        "display_name": "Qwen2.5-Coder 14B Instruct", "parameter_size": "14B",
        "context_window": 32768, "license": "apache-2.0",
        "best_at": ["coding"],
    ...
    },
    {
        ...
        "display_name": "Qwen2.5-Coder 32B Instruct", "parameter_size": "32B",
        "context_window": 32768, "license": "apache-2.0",
    ...
    {
        "id": "devstral-small", "family": "devstral",
        "display_name": "Devstral Small", "parameter_size": "24B",
        "context_window": 131072, "license": "apache-2.0",
    ...
    },
    {
        ...
        "display_name": "StarCoder2 7B", "parameter_size": "7B",
        "context_window": 16384, "license": "openrail-m",
    ...
    {
        "id": "qwen2.5-vl-7b-instruct", "family": "qwen2.5-vl",
        "display_name": "Qwen2.5-VL 7B Instruct", "parameter_size": "7B",
        "context_window": 32768, "license": "apache-2.0",
