...
class RequestEstimate:
    ...
    def tokens(self) -> int:
        ...
        return self.messages.tokens + self.tools.tokens + self.schema.tokens

    @property
    def floor(self) -> int:
        """Total lower bound across all components."""
        return self.messages.floor + self.tools.floor + self.schema.floor
...
def estimate_request(
    ...
    *,
    ...
    return RequestEstimate(messages=messages, tools=tools, schema=schema)
